...
export default async function ProfilePage() {
  ...
  return (
    <AppShell
      ...
      description="Profile and session identity used by the frontend auth layer and passed to the backend actor headers."
      eyebrow="Profile"
      title={session.name}
    >
      <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <Panel className="rounded-[30px] p-5 md:p-6">
          <PanelHeader
            description="Use the top-right menu to move between profile, dashboard, and logout."
            eyebrow="Navigation"
          ...
          <div className="mt-6 grid gap-3">
            {[
              ...
              "The right side now exposes Login / Profile / Logout depending on session state.",
